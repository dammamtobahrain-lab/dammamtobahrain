...
export const metadata = {
    title: "Hafer Al Baten to Bahrain Taxi | City Transfer",
    description: "Taxi service from Hafer Al Baten to Bahrain. Direct 4-hour transfer from the Northern region hub.",
};

export default function HaferPage() {
    return (
        <div className="section">
            <div className="container">
                <h1 className="section-title">GUIDE: HAFER AL BATEN TO BAHRAIN</h1>

                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>
                    <div style={{ border: '2px solid #000', padding: '3rem' }}>
                        <p style={{ fontSize: '1.2rem', fontFamily: 'Georgia, serif', lineHeight: '1.8' }}>
                            <strong>The Northern Hub.</strong> Hafer Al Baten is a major city serving the military base and northern communities. We offer a direct link to Bahrain, bypassing Dammam city traffic where possible.
                        </p>
                        ...
                        <div style={{ fontFamily: 'Georgia, serif', fontSize: '1.1rem', lineHeight: '1.8' }}>
                            ...
                            <p>The journey takes nearly 4.5 hours. It is a straight shot down the highway through Nariya and Jubail.</p>
                        </div>
                    ...
                    <div>
                        <div style={{ border: '2px solid #000', padding: '2rem', background: '#f9f9f9', position: 'sticky', top: '20px' }}>
                            ...
                            <ul style={{ listStyle: 'none', lineHeight: '2' }}>
                                <li><strong>Origin:</strong> Hafer Al Baten</li>
                                <li><strong>Dest:</strong> Bahrain</li>
                                <li><strong>Time:</strong> ~4.5 hrs</li>
