...
export const metadata = {
    title: "Madrik to Bahrain Taxi | Remote Transfer",
    description: "Taxi service from Madrik (Madrakah) to Bahrain. Specialized remote area transport.",
};

export default function MadrikPage() {
    return (
        <div className="section">
            <div className="container">
                <h1 className="section-title">GUIDE: MADRIK TO BAHRAIN</h1>

                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>
                    <div style={{ border: '2px solid #000', padding: '3rem' }}>
                        <p style={{ fontSize: '1.2rem', fontFamily: 'Georgia, serif', lineHeight: '1.8' }}>
                            <strong>The Remote Run.</strong> Madrik is one of our specialized routes. Due to the distance, we recommend booking a comfortable SUV for the journey.
                        </p>
                        ...
                        <div style={{ fontFamily: 'Georgia, serif', fontSize: '1.1rem', lineHeight: '1.8' }}>
                            ...
                            <p>Advance notice is required to dispatch a driver to this location.</p>
                        </div>
                    ...
                    <div>
                        <div style={{ border: '2px solid #000', padding: '2rem', background: '#f9f9f9', position: 'sticky', top: '20px' }}>
                            ...
                            <ul style={{ listStyle: 'none', lineHeight: '2' }}>
                                <li><strong>Origin:</strong> Madrik</li>
