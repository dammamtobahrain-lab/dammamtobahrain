...
export const metadata = {
    title: "Shedgum to Bahrain Taxi | Gas Plant Transfer",
    description: "Transport from Shedgum Gas Plant to Bahrain. Reliable commute for oil & gas professionals.",
};

export default function ShedgumPage() {
    return (
        <div className="section">
            <div className="container">
                <h1 className="section-title">GUIDE: SHEDGUM TO BAHRAIN</h1>

                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>
                    <div style={{ border: '2px solid #000', padding: '3rem' }}>
                        <p style={{ fontSize: '1.2rem', fontFamily: 'Georgia, serif', lineHeight: '1.8' }}>
                            <strong>The Processing Hub.</strong> Shedgum is one of the key gas plants in the KSA network. Located west of Hofuf, it is a frequent pickup point for our corporate clients.
                        </p>
                        ...
                        <div style={{ fontFamily: 'Georgia, serif', fontSize: '1.1rem', lineHeight: '1.8' }}>
                            <h2 style={{ fontFamily: 'Arial, sans-serif', marginTop: '2rem', marginBottom: '1rem', textTransform: 'uppercase' }}>Pickup</h2>
                            <p>We serve both the plant gates and the residential community area.</p>
                        </div>
                    ...
                    <div>
                        <div style={{ border: '2px solid #000', padding: '2rem', background: '#f9f9f9', position: 'sticky', top: '20px' }}>
                            ...
                            <ul style={{ listStyle: 'none', lineHeight: '2' }}>
                                <li><strong>Origin:</strong> Shedgum</li>
