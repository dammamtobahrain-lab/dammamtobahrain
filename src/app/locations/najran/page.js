...
export const metadata = {
    title: "Najran to Bahrain Taxi | Southern Transfer",
    description: "Taxi service from Najran to Bahrain. Specialized long-distance transport.",
};
    ...
    return (
        <div className="section">
            <div className="container">
                <h1 className="section-title">GUIDE: NAJRAN TO BAHRAIN</h1>

                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>
                    <div style={{ border: '2px solid #000', padding: '3rem' }}>
                        <p style={{ fontSize: '1.2rem', fontFamily: 'Georgia, serif', lineHeight: '1.8' }}>
                            <strong>The Historic South.</strong> From the valley of Najran to the island of Bahrain. A scenic but very long journey through the Empty Quarter edge or the mountain route.
                        </p>
                        ...
                        <div style={{ fontFamily: 'Georgia, serif', fontSize: '1.1rem', lineHeight: '1.8' }}>
                            ...
                            <p>We require 48 hours notice to position a vehicle in Najran for this trip.</p>
                        </div>
                    ...
                    <div>
                        <div style={{ border: '2px solid #000', padding: '2rem', background: '#f9f9f9', position: 'sticky', top: '20px' }}>
                            ...
                            <ul style={{ listStyle: 'none', lineHeight: '2' }}>
                                <li><strong>Origin:</strong> Najran</li>
                                <li><strong>Dest:</strong> Bahrain</li>
                                <li><strong>Distance:</strong> ~1300 KM</li>
                                <li><strong>Price:</strong> From 2,800 SAR</li>
                            </ul>
