...
export const metadata = {
    title: "Tinat to Bahrain Taxi | Remote Transfer",
    description: "Taxi service from Tinat (Remote Site) to Bahrain. Specialized long-distance transport.",
};

export default function TinatPage() {
    return (
        <div className="section">
            <div className="container">
                <h1 className="section-title">GUIDE: TINAT TO BAHRAIN</h1>

                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>
                    <div style={{ border: '2px solid #000', padding: '3rem' }}>
                        <p style={{ fontSize: '1.2rem', fontFamily: 'Georgia, serif', lineHeight: '1.8' }}>
                            <strong>Deep Desert.</strong> Tinat is a remote location requiring specialized transport planning.
                        </p>
                        ...
                        <div style={{ fontFamily: 'Georgia, serif', fontSize: '1.1rem', lineHeight: '1.8' }}>
                            <h2 style={{ fontFamily: 'Arial, sans-serif', marginTop: '2rem', marginBottom: '1rem', textTransform: 'uppercase' }}>Preparation</h2>
                            <p>Due to the isolation, we ensure all vehicles dispatched to Tinat have redundant communication and extra supplies.</p>
                        </div>
                    ...
                    <div>
                        <div style={{ border: '2px solid #000', padding: '2rem', background: '#f9f9f9', position: 'sticky', top: '20px' }}>
                            ...
                            <ul style={{ listStyle: 'none', lineHeight: '2' }}>
                                <li><strong>Origin:</strong> Tinat</li>
                                <li><strong>Dest:</strong> Bahrain</li>
                                <li><strong>Price:</strong> From 750 SAR</li>
                            </ul>
