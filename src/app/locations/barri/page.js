...
export const metadata = {
    title: "Barri to Bahrain Taxi | Field Transfer",
    description: "Transport from Barri Oil Field to Bahrain. Specialized service for offshore and onshore Al-Barri facilities.",
};

export default function BarriPage() {
    return (
        <div className="section">
            <div className="container">
                <h1 className="section-title">GUIDE: BARRI TO BAHRAIN</h1>

                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem' }}>
                    <div style={{ border: '2px solid #000', padding: '3rem' }}>
                        <p style={{ fontSize: '1.2rem', fontFamily: 'Georgia, serif', lineHeight: '1.8' }}>
                            <strong>The Barri Field.</strong> Located near Jubail, Barri is a massive crude increment. We serve the causeway and onshore plant gates for seamless crew transfers.
                        </p>
                        ...
                        <div style={{ fontFamily: 'Georgia, serif', fontSize: '1.1rem', lineHeight: '1.8' }}>
                            <h2 style={{ fontFamily: 'Arial, sans-serif', marginTop: '2rem', marginBottom: '1rem', textTransform: 'uppercase' }}>Safety First</h2>
                            <p>Our drivers are familiar with the specific gate requirements and safety protocols for pickup at Barri facilities.</p>
                        </div>
                    ...
                    <div>
                        <div style={{ border: '2px solid #000', padding: '2rem', background: '#f9f9f9', position: 'sticky', top: '20px' }}>
                            ...
                            <ul style={{ listStyle: 'none', lineHeight: '2' }}>
                                <li><strong>Origin:</strong> Barri Field</li>
