...
const data = serviceData['pet-transport'];
    ...
    return (
        <div className="section">
            <div className="container">
                ...
                <LocalMarketData data={data.marketData} cityName="Pet Transport" />
                ...
                <ExpertInsight text={data.expertOpinion} cityName="Pet Relocation" />
                ...
                <SchemaMarkup
                    ...
                    data={{
                        ...
                        breadcrumbs: [
                            ...
                            { name: 'Pet Transport', href: '/services/pet-transport' },
                        ],
                    }}
                />
            </div>
