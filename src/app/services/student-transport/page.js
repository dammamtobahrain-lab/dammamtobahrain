...
const data = serviceData['student-transport'];
    ...
    return (
        <div className="section">
            <div className="container">
                ...
                <div className="content-grid-responsive">
                    ...
                    <div className="content-sidebar-col">
                        <div className="sticky-sidebar">
                            <h3 className="sidebar-title">STUDENT BENEFITS</h3>
                ...
                <LocalMarketData data={data.marketData} cityName="Student Transport" />

                <ComparisonTable
                    title="Student Travel Options"
                    headers={data.comparison.headers}
                    rows={data.comparison.rows}
                    highlightRow={data.comparison.highlightRow}
                />

                <ExpertInsight text={data.expertOpinion} cityName="University Transport" />
                ...
                <SchemaMarkup
                    ...
                    data={{
                        ...
                        breadcrumbs: [
                            ...
                            { name: 'Student Transport', href: '/services/student-transport' },
                        ],
                    }}
                />
            </div>
