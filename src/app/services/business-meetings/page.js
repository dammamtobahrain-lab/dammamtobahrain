...
const data = serviceData['business-meetings'];
    ...
    return (
        <div className="section">
            <div className="container">
                ...
                <LocalMarketData data={data.marketData} cityName="Corporate Travel" />

                <ComparisonTable
                    title="Executive Vehicle Options"
                    headers={data.comparison.headers}
                    rows={data.comparison.rows}
                    highlightRow={data.comparison.highlightRow}
                />

                <ExpertInsight text={data.expertOpinion} cityName="Corporate Travel" />
                ...
                <SchemaMarkup
                    ...
                    data={{
                        ...
                        breadcrumbs: [
                            ...
                            { name: 'Business Meetings', href: '/services/business-meetings' },
                        ],
                    }}
                />
            </div>
