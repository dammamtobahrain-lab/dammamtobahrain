...
const data = serviceData['weekend-getaway'];
    ...
    return (
        <div className="section">
            <div className="container">
                ...
                <LocalMarketData data={data.marketData} cityName="Weekend Getaway" />

                <ComparisonTable
                    title="Weekend Getaway Vehicle Options"
                    headers={data.comparison.headers}
                    rows={data.comparison.rows}
                    highlightRow={data.comparison.highlightRow}
                />

                <ExpertInsight text={data.expertOpinion} cityName="Weekend Getaway" />
                ...
                <SchemaMarkup
                    ...
                    data={{
                        ...
                        breadcrumbs: [
                            ...
                            { name: 'Weekend Getaway', href: '/services/weekend-getaway' },
                        ],
                    }}
                />
            </div>
