...
export const metadata = {
    ...
    description: "Legal terms governing the use of our taxi services between Saudi Arabia and Bahrain. Booking, cancellation, pricing, and passenger conduct policies.",
};
        ...
        <>
            ...
            <div className="section">
                <div className="container">
                    ...
                    <div style={{ maxWidth: '800px', margin: '0 auto', fontFamily: 'var(--font-body)', fontSize: '1rem', lineHeight: '1.65', color: 'var(--color-text-main)' }}>

                        <p style={{ fontStyle: 'italic', marginBottom: '2rem', textAlign: 'center', fontSize: '0.85rem', color: 'var(--color-text-muted)' }}>Last Updated: February 1, 2026</p>
                        ...
                        <h3 style={{ marginTop: '1.8rem', marginBottom: '0.8rem', fontFamily: 'var(--font-heading)', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--color-text-main)' }}>1. Booking & Confirmation</h3>
                        <p>
                        ...
                        <h3 style={{ marginTop: '1.8rem', marginBottom: '0.8rem', fontFamily: 'var(--font-heading)', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--color-text-main)' }}>2. Pricing & Payment</h3>
                        <p>
                        ...
                        <h3 style={{ marginTop: '1.8rem', marginBottom: '0.8rem', fontFamily: 'var(--font-heading)', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--color-text-main)' }}>3. Cancellation & No-Show Policy</h3>
                        <p>
                        ...
                        <h3 style={{ marginTop: '1.8rem', marginBottom: '0.8rem', fontFamily: 'var(--font-heading)', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--color-text-main)' }}>4. Passenger Conduct</h3>
                        <p>
                        ...
                        <h3 style={{ marginTop: '1.8rem', marginBottom: '0.8rem', fontFamily: 'var(--font-heading)', fontSize: '1.1rem', textTransform: 'uppercase', letterSpacing: '0.05em', color: 'var(--color-text-main)' }}>5. Limitation of Liability</h3>
                        <p>
