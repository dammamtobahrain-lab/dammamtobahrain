                ...
                <div className="container" style={{ maxWidth: '900px' }}>
                    ...
                    <div style={{ background: '#0a0a0a', color: 'white', borderRadius: '16px', padding: '2.5rem', textAlign: 'center' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                            ...
                            <Link href="https://wa.me/966590209905" target="_blank" rel="noopener noreferrer" style={{ background: '#25D366', color: 'white', padding: '12px 28px', borderRadius: '8px', fontWeight: '800', textDecoration: 'none', fontSize: '0.9rem' }} data-track="quote_start" data-track-label="Causeway Bottom CTA">
                                BOOK ON WHATSAPP
                            </Link>
                        </div>
